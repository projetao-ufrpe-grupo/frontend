    ...
    <div className="container py-10">
      <div className="mb-8">
        ...
        <div className="flex flex-wrap gap-3 mb-8">
          ...
          >
            <Bath size={16} />
            {anuncio.qtdBanheiros}{" "}
            {anuncio.qtdBanheiros > 1 ? "banheiros" : "banheiro"}
          </Badge>
          <Badge
            variant="secondary"
            className="flex items-center gap-2 px-4 py-2 rounded-full text-base"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2">
          <div className="mb-10">
            <Carousel className="w-full">
              <CarouselContent>
                {anuncio.fotos?.map(
                  (
                    foto: { id: string; dadosBase64: string },
                    index: number
                  ) => (
                    <CarouselItem key={foto.id}>
                      {" "}
                      {/* Melhor usar foto.id como key */}
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab}>
            <TabsList className="mb-8 grid w-full grid-cols-4 h-14 rounded-2xl bg-gray-100 dark:bg-gray-800 p-1">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-medium text-lg">
                        {anuncio.qtdQuartos}{" "}
                        {anuncio.qtdQuartos > 1 ? "quartos" : "quarto"}
                      </p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
                ...
                <ul className="space-y-4">
                  <li className="flex items-center gap-3">
                    ...
                    <span className="text-lg">
                      Contrato mínimo de {anuncio.duracaoMinimaContrato} meses
                    </span>
                  </li>
                  <li className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-xl bg-green-50 flex items-center justify-center dark:bg-green-900/20">
                    ...
                    <span className="text-lg">
                      Caução de {formatCurrency(anuncio.caucao)}
                    </span>
                  </li>
                </ul>
              </div>
          ...
          <div className="space-y-8">
              ...
              <CardContent className="pt-8">
                <div className="text-center mb-6">
                  ...
                  <p className="text-muted-foreground">
                    + {formatCurrency(anuncio.condominio)} (condomínio)
                  </p>
                </div>
            ...
            <Card className="overflow-hidden rounded-3xl border-0 bg-white/80 backdrop-blur-sm shadow-lg ring-1 ring-gray-900/5 dark:bg-gray-800/80 dark:ring-gray-100/10">
              <CardContent className="pt-8">
                <div className="mb-6">
                  <Link
                    href={`/user/${anuncio.anunciante.id}`}
